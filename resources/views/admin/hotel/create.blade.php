...
@section('content')
    <div class="card card-custom card-sticky" id="kt_page_sticky_card">
        <form action="{{ route('hotel.add') }}" method="POST" id="kt_project_settings_form" class="form"
                    ...
                    <div class="col-xl-8">
                        ...
                        <div class="my-5">
                            <div class="form-group row">
                                ...
                                <div class="col-9">
                                    <input type="number" class="form-control input-custom" name="indexx" placeholder="please enter the place index" />
                                </div>
                            </div>
                        </div>
                        <div class="separator separator-dashed my-10"></div>
                        <div class="my-5">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-9">
                                    <select name="zone_id" class="form-control input-custom" 
