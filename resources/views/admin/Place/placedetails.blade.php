            ...
            <div class="card-body pt-5">
                ...
                <div class="d-flex gap-7 align-items-center">
                    ...
                    <div class="mb-6">
                        ...
                        <a class="fw-bold text-dark mb-4 fs-2 lh-base text-hover-primary">{{ $place->name }}</a>
                        <!--end::Title-->
                        <!--begin::Text-->
                        ...
                        <a class="d-block overlay" data-fslightbox="lightbox-hot-sales"
                            ...
                            <div class="overlay-wrapper bgi-no-repeat bgi-position-center bgi-size-cover card-rounded min-h-175px"
                                style="padding-right:400px ; background-image:url({{ asset('images/places/'. $place->image) }})">
                            </div>
                            <!--end::Image-->
                            <!--begin::Action-->
                ...
                <div class="tab-content" id="">
                    ...
                    <div class="tab-pane fade show active" id="kt_contact_view_general" role="tabpanel">
                        ...
                        <div class="d-flex flex-column gap-5 mt-7">
                            ...
                            <div class="d-flex flex-column gap-1">
                                <div class="fw-bold text-muted">location</div>
                                <iframe src="{{$place->location}}"  style="border:0;" allowfullscreen=""
...
<br>
                    <div class="d-flex justify-content-between"  >
                        ...
                        <a  class="btn btn-dark mt-3 mb-0"  href="{{route('place.index')}}" role="button">Back</a> 
                    </div>
