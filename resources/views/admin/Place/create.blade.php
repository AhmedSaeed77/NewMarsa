...
<div class="tab-content" id="myTabContent">
    <div class="tab-pane fade show active" id="kt_tab_pane_4" role="tabpanel">
        <form action="{{route('place.add')}}" method="POST" id="kt_project_settings_form" class="form" enctype="multipart/form-data">
            @csrf
        ...
        <div class="my-5">
         ...
         <div class="form-group row">
            <div class="col-3">City name:</div>
                <div class="col-9">
                    <input type="text" class="form-control input-custom"  name="name" placeholder="please enter the city name" required/>
        ...
        <div class="my-5">
         ...
         <div class="form-group row">
          ...
          <div class="col-9">
            ...
            <input type="text" class="form-control input-custom"  name="location" placeholder="please enter the location link" required/>
        ...
        <div class="my-5">
            ...
            <div class="form-group row">
               <div class="col-3">Short Overview:</div>
                   <div class="col-9">
                       <textarea  class="form-control input-custom"  name="shortoverview" placeholder="please shortover view" required></textarea>
                   </div>
               </div>
           </div>
           {{-- fix --}}
            ...
            <div class="col-lg-8">
                ...
                <div class="image-input image-input-outline" data-kt-image-input="true"
                    ...
                    <label class="btn btn-icon btn-circle btn-active-color-primary w-25px h-25px bg-white shadow"
                        ...
                        <i class="bi bi-pencil-fill fs-7"></i>
                        <!--begin::Inputs-->
                        <input type="file" name="coverimage" accept=".png, .jpg, .jpeg"required />
                        <input type="hidden" name="avatar_remove" />
                        <!--end::Inputs-->
                    </label>
                    <!--end::Label-->
       ...
       <div class="col-xl-8">
        ...
        <div class="my-5">
            ...
            <div class="form-group row">
               <div class="col-3">Short Overview:</div>
                   <div class="col-9">
                       <textarea   class="form-control input-custom"  name="shortoverview_de" placeholder="please shortover view"></textarea>
                   </div>
               </div>
           </div>
        ...
        <div class="my-52">
               ...
               <div class="form-group mb-1">
                <label for="exampleTextarea">Overview:</label>
                <textarea class="form-control editor" id="overview_de" name="overview_de" rows="3"></textarea>
               </div>
        </div>
        <div class="separator separator-dashed my-10"></div>
        ...
        <div class="my-5">
            <div class="my-5">
                ...
                <div class="form-group row">
                   <div class="col-3">Short Overview:</div>
                       <div class="col-9">
                           <textarea   class="form-control input-custom"  name="shortoverview_cz" placeholder="please shortover view"></textarea>
                       </div>
                   </div>
               </div>
