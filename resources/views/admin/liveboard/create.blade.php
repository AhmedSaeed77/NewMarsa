...
@section('content')
    ...
    <form action="{{ route('live.add') }}" method="POST" id="kt_project_settings_form" class="form"
                    ...
                    <!--begin::Form-->
                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-8">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-9">
                                            ...
                                            <input type="text" class="form-control form-control-solid" name="title"
                                                placeholder="please enter the liveboard title" required />
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="my-5">
                                    <div class="form-group row">
                                        <label class="col-3">liveboard place:</label>
                                        <div class="col-9">
                                            <select name="place[]" class="form-control form-control-solid"
                                                aria-label="Disabled select example" required multiple>
                                ...
                                <div class="my-52">
                                    <div class="form-group mb-1">
                                        ...
                                        <textarea class="form-control editor" name="overview" rows="3"></textarea>
                                    </div>
                                </div>
                                <div class="separator separator-dashed my-10"></div>
                                <div class="my-52">
                                    ...
                                    <div class="form-group mb-1">
                                        ...
                                        <textarea class="form-control editor" name="terms" rows="3"></textarea>
                                    </div>
                                </div>
                                <div class="separator separator-dashed my-10"></div>
                                <div class="my-52">
                                    <div class="form-group mb-1">
                                        ...
                                        <textarea class="form-control editor" name="highlights" rows="3"></textarea>
                                    </div>
                                </div>
                                <div class="separator separator-dashed my-10"></div>
                                <div class="my-52">
                                    <div class="form-group mb-1">
                                        ...
                                        <textarea class="form-control editor" name="faqs" rows="3"></textarea>
                                    </div>
                                </div>
                                <div class="separator separator-dashed my-10"></div>
                                <div class="my-52">
                                    <div class="form-group mb-1">
                                        ...
                                        <textarea class="form-control editor" name="includes" rows="3"></textarea>
                                    </div>
                                </div>
                                <div class="separator separator-dashed my-10"></div>
                                <div class="my-52">
                                    <div class="form-group mb-1">
                                        ...
                                        <textarea class="form-control editor" name="excludes" rows="3"></textarea>
                                    </div>
                                </div>
                                <div class="separator separator-dashed my-10"></div>
                                <div class="my-52">
                                    <div class="form-group mb-1">
                                        ...
                                        <textarea class="form-control editor" name="plan" rows="3"></textarea>
                                    </div>
                                </div>
                                <div class="separator separator-dashed my-10"></div>
                                ...
                                <div class="row mt-3 mb-3 mb-8">
                                    ...
                                    <div class="col-xl-9 fv-row mt-3 mb-3">
                                        <input type="number" class="form-control form-control-solid" name="additionalprice"
                                            placeholder="please enter the liveboard addtional price"  />
                                    </div>
                                </div>
                                <div class="separator separator-dashed my-10"></div>
                                 <div class="row mt-3 mb-3 mb-8">
                                ...
                                <div class="row mt-3 mb-3 mb-5">
                                    ...
                                    <div class="row mt-3 mb-3 mb-8">
                                        ...
                                        <div class="col-lg-4 col-md-6 col-sm-12">
                                            <div class="fs-6 fw-semibold mt-2 mb-3">Images Liveboard :</div>
                                        </div>
                                        <div class="col-l col-md col-sm-12">
                                            <input name="images[]" type="file" class="form-control form-control-solid"
                                                required multiple>
                                        </div>
                                        <!--end::Col-->
                                        <!--begin::Col-->
                                    ...
                                    <div class="row mt-3 mb-3 mb-8">
                                        ...
                                        <div class="col-lg-8 col-md-6 col-sm-12">
                                            <input type="text" name="duration" class="form-control form-control-solid"
                                                placeholder="please enter the liveboard duration" required>
                                        </div>
                                    </div>
                                    <div class="separator separator-dashed my-10"></div>
                                    <div class="row mt-3 mb-3 mb-8">
                                        ...
                                        <div class="col-lg-8 col-md-6 col-sm-12">
                                            <input type="number" name="rating" class="form-control form-control-solid"
                                                placeholder="please enter the liveboard rating" required>
                                        </div>
                                        <!--end::Col-->
                                    </div>
                                </div>
                        ...
                        <div class="col-xl-8">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-9">
                                        <input class="form-control form-control-solid" type="text" name="title_de"
                                            placeholder="please enter the liveboard title"  />
                                    </div>
                                </div>
                            ...
                            <div class="my-52">
                                ...
                                <div class="form-group mb-1">
                                    ...
                                    <textarea class="form-control" name="descriptiuonadditionalprice_de" rows="3"></textarea>
                                </div>
                            ...
                            <div class="my-52">
                                ...
                                <div class="form-group mb-1">
                                    <label for="exampleTextarea">Overview:</label>
                                    <textarea class="form-control editor" name="overview_de" rows="3"></textarea>
                                </div>
                            ...
                            <div class="my-52">
                                ...
                                <div class="form-group mb-1">
                                    <label for="exampleTextarea">Terms and conditions:</span></label>
                                    <textarea class="form-control editor" name="terms_de" rows="3"></textarea>
                                </div>
                            </div>
                            <div class="separator separator-dashed my-10"></div>
                            <div class="my-52">
                                ...
                                <div class="form-group mb-1">
                                    <label for="exampleTextarea">Highlights:</span></label>
                                    <textarea class="form-control editor" name="highlights_de" rows="3"></textarea>
                                </div>
                            </div>
                            <div class="separator separator-dashed my-10"></div>
                            <div class="my-52">
                                <div class="form-group mb-1">
                                    <label for="exampleTextarea">Popular questions:</span></label>
                                    <textarea class="form-control editor" name="faqs_de" rows="3"></textarea>
                                </div>
                            </div>
                            <div class="separator separator-dashed my-10"></div>
                            <div class="my-52">
                                <div class="form-group mb-1">
                                    <label for="exampleTextarea">Includes:</span></label>
                                    <textarea class="form-control editor" name="includes_de" rows="3"></textarea>
                                </div>
                            </div>
                            <div class="separator separator-dashed my-10"></div>
                            <div class="my-52">
                                ...
                                <div class="form-group mb-1">
                                    <label for="exampleTextarea">Excludes:</span></label>
                                    <textarea class="form-control editor" name="excludes_de" rows="3"></textarea>
                                </div>
                            </div>
                            <div class="separator separator-dashed my-10"></div>
                        <div class="my-52">
                            <div class="form-group mb-1">
                                <label for="exampleTextarea">plan:</span></label>
                                <textarea class="form-control editor" name="plan_de" rows="3"></textarea>
                            </div>
                        </div>
                        <div class="separator separator-dashed my-10"></div>
                        </div>
                        ...
                        <div class="col-xl-8">
                            ...
                            <div class="my-52">
                                <div class="form-group mb-1">
                                    ...
                                    <textarea class="form-control editor" name="overview_cz" rows="3"></textarea>
                                </div>
                            </div>
                            <div class="separator separator-dashed my-10"></div>
                            <div class="my-52">
                                <div class="form-group mb-1">
                                    <label for="exampleTextarea">Terms and conditions:</span></label>
                                    <textarea class="form-control editor" name="terms_cz" rows="3"></textarea>
                                </div>
                            </div>
                            <div class="separator separator-dashed my-10"></div>
                            <div class="my-52">
                                <div class="form-group mb-1">
                                    <label for="exampleTextarea">Highlights:</span></label>
                                    <textarea class="form-control editor" name="highlights_cz" rows="3"></textarea>
                                </div>
                            </div>
                            <div class="separator separator-dashed my-10"></div>
                            <div class="my-52">
                                <div class="form-group mb-1">
                                    <div class="form-group mb-1">
                                        <label for="exampleTextarea">Popular questions:</span></label>
                                        <textarea class="form-control editor" name="faqs_cz" rows="3"></textarea>
                                    </div>
                                </div>
                                <div class="separator separator-dashed my-10"></div>
                                <div class="my-52">
                                    <div class="form-group mb-1">
                                        <label for="exampleTextarea">Includes:</span></label>
                                        <textarea class="form-control editor" name="includes_cz" rows="3"></textarea>
                                    </div>
                                </div>
                                <div class="separator separator-dashed my-10"></div>
                                <div class="my-52">
                                    <div class="form-group mb-1">
                                        <label for="exampleTextarea">Excludes:</span></label>
                                        <textarea class="form-control editor" name="excludes_cz" rows="3"></textarea>
                                    </div>
                                </div>
                                <div class="separator separator-dashed my-10"></div>
                                <div class="my-52">
                                    <div class="form-group mb-1">
                                        <label for="exampleTextarea">plan:</span></label>
                                        <textarea class="form-control editor" name="plan_cz" rows="3"></textarea>
                                    </div>
                                </div>
                                <div class="separator separator-dashed my-10"></div>
                            </div>
