                    ...
                    <form id='newblog'>
                        ...
                        <div class="row m-3">
                            <div class="col-12 col-md-4">
                                ...
                                <input  class="form-control"   name="indexx"     type="text">
                            </div>
                            <div class="col-12 col-md-4">
            ...
            app = new Vue({
                ...
                methods:{
                    ...
                    getimages:function()
                    {
                        ...
                        url='{{route('live.getimagesvue',':id')}}';
                        url=url.replace(':id',this.activityId);
                        axios.get(url).then(response => {
                            console.log(response);
                            this.images=response.data.liveboardimages;
                ...
                savedata:function(){
                    ...
                    axios.post('{{ route('live.updateimage') }}', formData).then(response => {
