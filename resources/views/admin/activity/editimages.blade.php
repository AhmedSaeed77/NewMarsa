        ...
        <div class="card-body p-lg-20">
            ...
            <div class="card-body p-lg-20">
                ...
                <select v-model.number="activityId"  @change = "getimages" class="form-control form-control-solid" aria-label="Disabled select example">
                    ...
                    @foreach (App\Models\Activity::all() as $type)
            ...
            app = new Vue({
                ...
                methods:{
                    ...
                    getimages:function()
                    {
                        ...
                        url='{{route('activ.getimagesvue',':id')}}';
                ...
                savedata:function(){
                    ...
                    axios.post('{{ route('activ.updateimage') }}', formData).then(response => {
