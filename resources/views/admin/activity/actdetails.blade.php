            ...
            <div class="card-body pt-5">
                ...
                <div class="d-flex gap-7 align-items-center">
                    ...
                    <div class="mb-6">
                        ...
                        <a class="fw-bold text-dark mb-4 fs-2 lh-base text-hover-primary">{{ $activity->title }}</a>
                        <!--end::Title-->
                        <!--begin::Text-->

                        <a class="d-block overlay" data-fslightbox="lightbox-hot-sales"
                            href="{{ asset('/images/activities/' . $activity->image) }}">
                            <!--begin::Image-->
                            <div class="overlay-wrapper bgi-no-repeat bgi-position-center bgi-size-cover card-rounded min-h-175px"
                                style="padding-right:400px ; background-image:url({{ asset('/images/activities/' . $activity->image) }})"></div>
                            <!--end::Image-->
                            <!--begin::Action-->
                    ...
                    <div class="tab-pane fade show active" id="kt_contact_view_general" role="tabpanel">
                        ...
                        <div class="d-flex flex-column gap-5 mt-7">
                            ...
                            <div class="d-flex flex-column gap-1">
                                <div class="fw-bold text-muted">Activity type</div>
                                <div class="fw-bold fs-5">{{App\Models\ActivityType::find($activity->type_id)->type}}</div>
                            </div>
                            <!--end::Company name-->
                            <!--begin::City-->
                            <div class="d-flex flex-column gap-1">
                                <div class="fw-bold text-muted">City</div>
                                <div class="fw-bold fs-5">{{App\Models\Place::find($activity->place_id)->name}}</div>
                            </div>
                            <!--end::City-->
                            <!--begin::Country-->
                            <div class="d-flex flex-column gap-1">
                                <div class="fw-bold text-muted">price</div>
                                <div class="fw-bold fs-5">{{$activity->price}}</div>
                            </div>
                            <!--end::Country-->
                            <div class="d-flex flex-column gap-1">
                                <div class="fw-bold text-muted">Availability</div>
                                <div class="fw-bold fs-5">{{$activity->availability}}</div>
                            </div>
                            <!--begin::Notes-->
                            <div class="d-flex flex-column gap-1">
                ...
                <div class="d-flex justify-content-between"  >
                    <a class="btn btn-primary" href="{{route('activ.edit',$activity->id)}}">Edit</a>
                    <a  class="btn btn-dark mt-3 mb-0"  href="{{route('activ.index')}}" role="button">Back</a> 
                </div>
