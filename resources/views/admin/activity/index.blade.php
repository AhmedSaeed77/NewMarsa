        ...
        <div class="card-body p-lg-20">
            <div class="card-body p-lg-20">
                ...
                <div class="card-title d-flex align-items-center">
                    ...
                    <a href="{{route('activ.create')}}" class="btn btn-primary" id="kt_project_settings_submit">Add activity</a>
                            ...
                            <div class="card card-flush h-xl-100">
                                ...
                                <div class="card-body text-center pb-5">
                                    ...
                                    <a class="d-block overlay" data-fslightbox="lightbox-hot-sales"
                                        href="{{ asset('/images/activities/' . $activ->image) }}">
                                        <!--begin::Image-->
                                        <div class="overlay-wrapper bgi-no-repeat bgi-position-center bgi-size-cover card-rounded mb-7"
                                            style="height: 266px;background-image:url('{{ asset('/images/activities/' . $activ->image) }}')">
                                        </div>
                                        <!--end::Image-->
                                        <!--begin::Action-->
                                    ...
                                    <div class="d-flex align-items-end flex-stack mb-1">
                                        ...
                                        <div class="text-start">
                                            <span class="fw-bold text-gray-800 cursor-pointer text-hover-primary fs-4 d-block">{{ $activ->title }}</span>
                                            
                                        </div>
                                        <!--end::Title-->
                                        <!--begin::Total-->
                                        <span class="text-gray-600 text-end fw-bold fs-6">${{ $activ->price }}</span>
                                        <!--end::Total-->
                                    </div>
                                    <!--end::Info-->
                                </div>
                                ...
                                <div class="card-footer d-flex flex-stack pt-0">
                                    <!--begin::Link-->
                                    <a class="btn btn-sm btn-primary flex-shrink-0 me-2" href="{{ route('activ.actdetails',$activ->id) }}">Activity details</a>
                                    <button type="submit" class="btn btn-sm btn-dark flex-shrink-0 me-2" ><a style="color:ffff0;" href="{{ route('activ.edit',$activ->id) }}">Activity Edit</a></button>
                                    ...
                                    <button type="submit" onclick="deleteFunction({{ $activ->id }})"
