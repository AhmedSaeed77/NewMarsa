...
margin-bottom: 8px!important;">
    ...
    <div class="card" id="activty">
        ...
        <div class="card-body p-lg-20">
            ...
            <div class="card-body p-lg-20">
                <label class="form-label">  Home Cover </label>
                    ...
                    <form id='newblog'>
                        ...
                        <div class="row m-3">
                            <div class="col-12 col-md-4">
                                ...
                                <select name="indexx" class="form-control form-control-solid" aria-label="Disabled select example">
                                    <option selected value="0" disabled>Choose type</option>
            ...
            app = new Vue({
                ...
                methods:{
                    ...
                    getimages:function()
                    {
                        ...
                        url='{{route('homecover.getimagesvue')}}';
                        //url=url.replace(':id',this.activityId);
                        axios.get(url).then(response => {
                            console.log(response);
                            this.images=response.data.activityimages;
                    ...
                    deleteFunction:function(id) {
                        ...
                        Swal.fire({
                            ...
                            if (result.isConfirmed) {
                                    $.ajax({
                                        type: 'post',
                                        url: "{{ route('homecover.deleteimage') }}",
                                        data: {
                                            '_token': "{{ csrf_token() }}",
                                            'id': id1,
                                        },
                ...
                savedata:function(){
                    this.error = []
                    //this.validation(this.indexx , ' اختر الترتيب  ')
                    ...
                    axios.post('{{ route('homecover.updateimage') }}', formData).then(response => {
