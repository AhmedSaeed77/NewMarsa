...
margin-bottom: 8px!important;">
    ...
    <div class="card" id="activty">
        ...
        <div class="card-body p-lg-20">
            ...
            <div class="card-body p-lg-20">
                <label class="form-label">  Parteners </label>
            ...
            app = new Vue({
                ...
                methods:{
                    ...
                    getimages:function()
                    {
                        ...
                        url='{{route('partener.getimagesvue')}}';
                    ...
                    deleteFunction:function(id) {
                        ...
                        Swal.fire({
                            ...
                            if (result.isConfirmed) {
                                    $.ajax({
                                        type: 'post',
                                        url: "{{ route('partener.deleteimage') }}",
                                        data: {
                                            '_token': "{{ csrf_token() }}",
                                            'id': id1,
                                        },
                ...
                savedata:function(){
                    ...
                    axios.post('{{ route('partener.updateimage') }}', formData).then(response => {
