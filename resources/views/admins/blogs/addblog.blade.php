...
<div class="tab-content" id="myTabContent">
    ...
    <form action="{{route('blog.addblog')}}" method="POST" id="kt_project_settings_form" class="form" enctype="multipart/form-data">
        @csrf
       ...
       <div class="col-xl-8">
        <div class="my-5">
         ...
         <div class="form-group row">
          ...
          <div class="col-9">
            ...
            <input type="text" class="form-control input-custom"  name="title_en"  placeholde="enter blog title " required/>
          </div>
         </div>
        </div>
        ...
        <div class="my-5">
         ...
         <div class="form-group row">
          ...
          <textarea class="form-control editor formdataforev"  name="content_en" rows="3"  placeholde="enter content title "required></textarea>
          </div>
         </div>
        </div>
                <div class="separator separator-dashed my-10"></div>
        <div class="row mt-3 mb-3 mb-5">
            <!--begin::Col-->
            <div class="col-xl-3">
                <div class="fs-6 fw-semibold mt-2 mb-3">Blog image:</div>
            </div>
            <!--end::Col-->
            <!--begin::Col-->
            <div class="col-lg-8">
                ...
                <div class="image-input image-input-outline" data-kt-image-input="true"
                    style="background-image: url('assets/media/svg/brand-logos/volicity-9.svg')">
                    ...
                    <label class="btn btn-icon btn-circle btn-active-color-primary w-25px h-25px bg-white shadow"
                        ...
                        <!--begin::Inputs-->
                        <input type="file" name="image" accept=".png, .jpg, .jpeg" class="form-control input-custom" required/>
            ...
            <div class="my-5">
                ...
                <div class="form-group row">
                 ...
                 <div class="col-9">
                    ...
                    <input name="images[]"  type="file" class="form-control input-custom" required multiple>
                 </div>
                </div>
               </div>
                       <div class="separator separator-dashed my-10"></div>
      ...
      <div class="row">
       ...
       <div class="col-xl-8">
        <div class="my-5">
         ...
         <div class="form-group row">
          <label class="col-3">Blog title :</label>
          <div class="col-9">
           <input class="form-control input-custom" type="text" name="title_de"  placeholde="enter blog title " required/>
          </div>
         </div>
        </div>
        ...
        <div class="my-5">
            ...
            <div class="form-group row">
             ...
             <textarea class="form-control editor formdataforev"  name="content_de" rows="3"  placeholde="enter content title "required></textarea>
             </div>
            </div>
           </div>
...
<div class="card card-custom card-sticky" id="kt_page_sticky_card">
    ...
    <div class="card-toolbar">
        <a href="{{ route('blog.blogs') }}" class="btn btn-light btn-active-light-primary me-2">Discard</a>
        <div class="btn-group">
            <button type="submit" class="btn btn-primary" id="kt_project_settings_submit">Save Changes</button>
        </div>
    </div>
       ...
       <div class="col-xl-8">
        <div class="my-5">
         ...
         <div class="form-group row">
            <label class="col-3">Blog title :</label>
            <div class="col-9">
             <input class="form-control input-custom" type="text" name="title_cz" placeholde="enter blog title " required/>
            </div>
           </div>
        </div>
        <div class="separator separator-dashed my-10"></div>
        <div class="my-5">
            ...
            <div class="form-group row">
             ...
             <textarea class="form-control editor formdataforev"  name="content_cz" rows="3"  placeholde="enter content title "required></textarea>
             </div>
            </div>
           </div>
