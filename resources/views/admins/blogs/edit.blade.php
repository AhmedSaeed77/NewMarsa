...
<div class="tab-content" id="myTabContent">
    ...
    <form action="{{route('blog.updateblog',$blog->id)}}" method="POST" id="kt_project_settings_form" class="form" enctype="multipart/form-data">
        @csrf
       ...
       <div class="col-xl-8">
        <div class="my-5">
         ...
         <div class="form-group row">
          ...
          <div class="col-9">
            ...
            <input type="text" class="form-control input-custom"  name="title_en" value="{{ $blog->title_en }}" required/>
          </div>
         </div>
        </div>
        ...
        <div class="my-5">
         ...
         <div class="form-group row">
          ...
          <textarea class="form-control editor formdataforev"  name="content_en" rows="3" required>{!! $blog->content_en !!}</textarea>
          </div>
         </div>
        </div>
                <div class="separator separator-dashed my-10"></div>
        <div class="row mt-3 mb-3 mb-5">
            ...
            <div class="col-lg-8">
                ...
                <div class="image-input image-input-outline" data-kt-image-input="true"
                    style="background-image: url({{ asset('images/blogs/'. $blog->image) }})">
                    <!--begin::Preview existing avatar-->
                    <div class="image-input-wrapper w-125px h-125px bgi-position-center"
                        style="background-size: 75%; background-image: url({{ asset('images/blogs/'. $blog->image) }})">
                    </div>
       ...
       <div class="col-xl-8">
        <div class="my-5">
         ...
         <div class="form-group row">
          ...
          <div class="col-9">
           <input class="form-control input-custom" type="text" name="title_de" value="{{ $blog->title_de }}" required/>
          </div>
         </div>
        </div>
        ...
        <div class="my-52">
               ...
               <div class="form-group mb-1">
                ...
                <textarea class="form-control editor formdataforev"  name="content_de" rows="3" required>{!! $blog->content_de !!}</textarea>
               </div>
        </div>
        <div class="separator separator-dashed my-10"></div>
       </div>
       ...
       <div class="col-xl-8">
        <div class="my-5">
         ...
         <div class="form-group row">
            <label class="col-3">Blog title :</label>
            <div class="col-9">
             <input class="form-control input-custom" type="text" name="title_cz" value="{{ $blog->title_cz }}" required/>
            </div>
           </div>
        </div>
        <div class="separator separator-dashed my-10"></div>
        <div class="my-52">
               <div class="form-group mb-1">
                <label for="exampleTextarea">Content:</span></label>
                <textarea class="form-control editor formdataforev"  name="content_cz" rows="3" required>{!! $blog->content_cz !!}</textarea>
               </div>
        </div>
           <div class="separator separator-dashed my-10"></div>
        </div>
