...
<div class="tab-content" id="myTabContent">
    ...
    <form action="{{route('boat.addbboat')}}" method="POST" id="kt_project_settings_form" class="form" enctype="multipart/form-data">
        @csrf
       ...
       <div class="col-xl-8">
        <div class="my-5">
         ...
         <div class="form-group row">
          ...
          <div class="col-9">
            ...
            <input type="text" class="form-control input-custom"  name="name_en"  placeholde="enter boat name " required/>
          </div>
         </div>
        </div>
        ...
        <div class="my-5">
         ...
         <div class="form-group row">
          ...
          <textarea class="form-control editor"  name="overview_en" rows="3"  placeholde="enter content boat "required></textarea>
          </div>
         </div>
        </div>
                <div class="separator separator-dashed my-10"></div>
        <div class="row mt-3 mb-3 mb-5">
            ...
            <div class="my-5">
                ...
                <div class="form-group row">
                   <div class="col-3">Boat Images:</div>
                 <div class="col-9">
       ...
       <div class="col-xl-8">
        <div class="my-5">
         ...
         <div class="form-group row">
          ...
          <div class="col-9">
           <input class="form-control input-custom" type="text" name="name_de"  placeholde="enter boat name " required/>
          </div>
         </div>
        </div>
        ...
        <div class="my-5">
            ...
            <div class="form-group row">
             ...
             <textarea class="form-control editor"  name="overview_de" rows="3"  placeholde="enter content boat "required></textarea>
             </div>
            </div>
           </div>
       ...
       <div class="col-xl-8">
        <div class="my-5">
         ...
         <div class="form-group row">
            <label class="col-3">Boat Name :</label>
            <div class="col-9">
             <input class="form-control input-custom" type="text" name="name_cz" placeholde="enter boat name " required/>
            </div>
           </div>
        </div>
        <div class="separator separator-dashed my-10"></div>
        <div class="my-5">
            ...
            <div class="form-group row">
             ...
             <textarea class="form-control editor"  name="overview_cz" rows="3"  placeholde="enter content boat "required></textarea>
             </div>
            </div>
           </div>
