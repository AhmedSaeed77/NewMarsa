        ...
        <div class="card card-flush h-lg-100" id="kt_contacts_main">
            ...
            <div class="card-body pt-5" >
                ...
                <div class="d-flex gap-7 align-items-center">
                    <!--begin::Avatar-->
                    <div class="mb-6">
                        <a class="fw-bold text-dark mb-4 fs-2 lh-base text-hover-primary">{{ $boat->name_en }}</a>
                        <a class="d-block overlay" data-fslightbox="lightbox-hot-sales"
                            href="{{ asset('/images/boats/' . $boat->image) }}">
                            <div class="overlay-wrapper bgi-no-repeat bgi-position-center bgi-size-cover card-rounded min-h-175px"
                                style="padding-right:400px ; background-image:url({{ asset('/images/boats/' . $boat->image) }})"></div>
                    ...
                    <div id="carouselExampleControls" class="carousel slide" data-bs-ride="carousel">
                        <div class="carousel-inner">
                          ...
                          <div class="carousel-item active">
                            <img src="{{ asset('/images/boats/'.$img->image) }}" class="d-block " style="height: 200px; width: 330px" alt="...">
                          </div>
                          @endforeach
                        </div>
                    ...
                    <div class="tab-pane fade show active" id="kt_contact_view_general" role="tabpanel">
                        ...
                        <div class="d-flex flex-column gap-5 mt-7">
                            <div class="d-flex flex-column gap-1">
                                <div class="fw-bold text-muted">Boat Overview</div>
                                <div class="fw-bold fs-5"> {!!$boat->overview_en!!}</div>
                            </div>  
                        </div>
                    </div>
                </div>
                ...
                <div class="d-flex justify-content-between"  >
                    <a class="btn btn-primary" href="{{route('boat.editboat',$boat->id)}}">Edit</a>
                    <a  class="btn btn-dark mt-3 mb-0"  href="{{route('boat.boats')}}" role="button">Back</a>
                </div>
            </div>
            <!--end::Card body-->
        </div>
