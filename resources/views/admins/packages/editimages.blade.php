        ...
        <div class="card-body p-lg-20">
            ...
            <div class="card-body p-lg-20">
                ...
                <select v-model.number="activityId"  @change = "getimages" class="form-control form-control-solid" aria-label="Disabled select example">
                    ...
                    @foreach (App\Models\Package::all() as $type)
            ...
            app = new Vue({
                ...
                methods:{
                    ...
                    getimages:function()
                    {
                        ...
                        url='{{route('package.getimagesvue',':id')}}';
                        url=url.replace(':id',this.activityId);
                        axios.get(url).then(response => {
                            console.log(response);
                            this.images=response.data.packageimages;
                ...
                savedata:function(){
                    ...
                    axios.post('{{ route('package.updateimage') }}', formData).then(response => {
