...
<form action="{{route('package.addpackage')}}" method="POST" id="kt_project_settings_form" class="form" enctype="multipart/form-data">
    @csrf
       ...
       <div class="col-xl-8">
        <div class="my-5">
         ...
         <div class="form-group row">
          ...
          <div class="col-9">
            ...
            <input type="text" class="form-control form-control-solid" name="name_en" placeholder="please enter the package name" required/>
          </div>
         </div>
        </div>
         ...
         <div class="form-group row">
                            ...
                            <div class="col-9">
                                ...
                                <select name="type" class="form-control form-control-solid"
                                    ...
                                    <option value="rest">Marsa Alam, Porto Ghaleb and El-Quseir</option>
                                </select>
                            </div>
                        </div>
        </div>
           ...
           <div class="form-group row">
                            ...
                            <div class="col-9">
                                ...
                                <input type="text" class="form-control form-control-solid" name="duration"
                                    placeholder="please enter the duration" required />
                            </div>
                        </div>
           ...
           <div class="form-group row">
                            ...
                            <div class="col-9">
                                ...
                                <input type="number" class="form-control form-control-solid" name="descount"
                                    placeholder="please enter the descount" required />
                            </div>
                        </div>
        ...
        <div class="row mt-3 mb-3 mb-8">
            ...
            <div class="col-xl-9 fv-row mt-3 mb-3">
                <input type="number" class="form-control form-control-solid" name="price"
                    placeholder="please enter the package price" required/>
            </div>
        </div>
        <div class="separator separator-dashed my-10"></div>
        ...
        <div class="row mt-3 mb-3 mb-8">
            ...
            <div class="col-xl-9 fv-row mt-3 mb-3">
                <input type="number" class="form-control form-control-solid" name="pricechild"
                    placeholder="please enter the package price for the child" required/>
            </div>
        </div>
        <div class="separator separator-dashed my-10"></div>
        <div class="row mt-3 mb-3 mb-8">
            ...
            <div class="col-xl-9 fv-row mt-3 mb-3">
                <input type="number" class="form-control form-control-solid" name="additionalprice"
                    placeholder="please enter the package adddtional price" />
            </div>
        </div>
        <div class="separator separator-dashed my-10"></div>
        <div class="row mt-3 mb-3 mb-8">
        ...
        <div class="my-52">
           ...
           <div class="form-group mb-1">
            ...
            <textarea class="editor" name="description_en" rows="3" ></textarea>
           </div>
        ...
        <div class="my-52">
           <div class="form-group mb-1">
            ...
            <textarea class="editor" name="includes_en" rows="3" ></textarea>
           </div>
        ...
        <div class="row mt-3 mb-3 mb-5">
            ...
            <div class="row mt-3 mb-3 mb-8">
                ...
                <div class="col-lg-4 col-md-6 col-sm-12">
                    <div class="fs-6 fw-semibold mt-2 mb-3">Images 3 Package :</div>
                </div>
...
<div class="form-group row">
 ...
 <input type="text" class="form-control form-control-solid" name="name_de" placeholder="please enter the package name" />
 </div>
</div>
</div>
       <div class="separator separator-dashed my-10"></div>
       <div class="my-52">
           ...
           <div class="form-group mb-1">
            <label for="exampleTextarea">Description:</span></label>
            <textarea class="editor" name="description_de" rows="3" ></textarea>
           </div>
        ...
        <div class="my-52">
           <div class="form-group mb-1">
            <label for="exampleTextarea">Includes:</span></label>
            <textarea class="editor" name="includes_de" rows="3" ></textarea>
           </div>
...
<div class="form-group row">
 ...
 <div class="col-9">
   ...
   <input type="text" class="form-control form-control-solid" name="name_cz" placeholder="please enter the package name" />
 </div>
</div>
</div>
       <div class="separator separator-dashed my-10"></div>
        <div class="my-52">
           ...
           <div class="form-group mb-1">
            <label for="exampleTextarea">Description:</span></label>
            <textarea class="editor" name="description_cz" rows="3" ></textarea>
           </div>
        ...
        <div class="my-52">
           <div class="form-group mb-1">
            <label for="exampleTextarea">Includes:</span></label>
            <textarea class="editor" name="includes_cz" rows="3" ></textarea>
           </div>
