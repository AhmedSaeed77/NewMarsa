...
{{-- <div class="card"> --}}
    ...
    <div class="row g-5 g-xl-10 mb-5 mb-xl-10">
        <div class="card-title d-flex align-items-center">
            ...
            <a href="{{route('package.createpackage')}}" class="btn btn-primary" id="kt_project_settings_submit">Add Package</a>
        ...
        <div class="col-sm-6 col-xxl-4">
            ...
            <div class="card card-flush h-xl-100">
                ...
                <div class="card-body text-center pb-5">
                    <!--begin::Overlay-->
                    <a class="d-block overlay" data-fslightbox="lightbox-hot-sales" href="{{ asset('images/package/'.$pakage->image) }}">
                        <!--begin::Image-->
                        <div class="overlay-wrapper bgi-no-repeat bgi-position-center bgi-size-cover card-rounded mb-7" style="height: 266px;background-image:url({{ asset('images/package/'.$pakage->image) }})"></div>
                        <!--end::Image-->
                        <!--begin::Action-->
                    ...
                    <div class="d-flex align-items-end flex-stack mb-1">
                        ...
                        <div class="text-start">
                            <span class="fw-bold text-gray-800 cursor-pointer text-hover-primary fs-4 d-block">{{$pakage->name_en}}</span>
                            <span class="text-gray-400 mt-1 fw-bold fs-6">{{$pakage->duration}}</span>
                        </div>
                        <span class="text-gray-600 text-end fw-bold fs-6"> $ {{$pakage->descount}}</span>
                    </div>
                </div>
                <div class="card-footer d-flex flex-stack pt-0">
                    <!--begin::Link-->
                    <button type="submit" class="btn btn-sm btn-primary flex-shrink-0 me-2" ><a style="color:ffffff;" href="{{ route('package.showpackage',$pakage->id) }}">Package details</a></button>
                    <button type="submit" class="btn btn-sm btn-dark flex-shrink-0 me-2" ><a style="color:ffffff;" href="{{ route('package.editpackage',$pakage->id) }}">Package Edit</a></button>
                    <!--end::Link-->
                    <!--begin::Link-->
                    
                    <button type="submit" onclick="deleteFunction({{ $pakage->id }})"
    ...
    function deleteFunction(id) {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                $.ajax({
                    type: 'post',
                    url: "{{ route('package.deletepackage') }}",
                    data: {
                        '_token': "{{ csrf_token() }}",
                        'id': id1,
                    },
