        ...
        var KTDatatablesDataSourceAjaxServer = function() {
            var initTable1 = function() {
                ...
                table.DataTable({
                    ...
                    searching:false,
                    ajax: {
                        url: "{{ route('transportingbookings.cashDeleteDatatable') }}",
                        data: function(d) {
                            d.title = $('#title').val();
                            d.month = $('#month').val();
                            d.method = $('#method').val();
                ...
                $('#kt_table_1 tbody').on('click', '.delete', function() {
                    ...
                    Swal.fire({
                        ...
                        if (result.isConfirmed) {
                            ...
                            $.ajax({
                                type: 'post',
                                url: "{{ route('transportingbookings.cashdelete') }}",
                                data: {
                                    '_token': "{{ csrf_token() }}",
                                    'id': value,
                                },
                                success: (response) => {
                                    ...
                                    window.location.href = '{{ route('transportingbookings.indexCashDeleted' )}}';
                                },
