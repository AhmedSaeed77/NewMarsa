       ...
       <div class="col-xl-8">
        ...
        <div class="my-52">
         ...
         <div class="form-group mb-1">
            ...
            <textarea class="form-control formdataforev" name="excludes" rows="3" >{{$event->exclude}}</textarea>
           </div>
           </div>
        ...
        <div class="row mt-3 mb-3 mb-8">
            ...
            <div class="col-xl-9 fv-row mt-3 mb-3">
                ...
                value="{{$event->pricechild}}" required/>
            </div>
        </div>
        <div class="separator separator-dashed my-10"></div>
        <div class="row mt-3 mb-3 mb-8">
      ...
      <div class="row">
       ...
       <div class="col-xl-8">
        ...
        <div class="my-52">
           ...
           <div class="form-group mb-1">
            <label for="exampleTextarea">Excludes:</span></label>
            <textarea class="form-control formdataforev"  name="excludes_cz" rows="3" >{{$event->exclude_cz}}</textarea>
           </div>
           </div>
