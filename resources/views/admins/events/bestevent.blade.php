...
@foreach (\App\Models\BestEvent::where('id',1)->get() as $set)
<form action="{{route('event.bestupdate',$set->id)}}" method="post"  class="form" enctype="multipart/form-data">
    @csrf
       ...
       <div class="col-xl-8">
        ...
        <div class="my-52">
            <div class="form-group mb-1">
                <label for="exampleTextarea">Best Event:</label>
                <textarea class="form-control editor"  name="best_en" rows="3">{{$set->best_en}}</textarea>
               </div>
        </div>
      ...
      <div class="row">
       ...
       <div class="col-xl-8">
        ...
        <div class="my-52">
            <div class="form-group mb-1">
                <label for="exampleTextarea">Best Event:</label>
                <textarea class="form-control editor"   name="best_de" rows="3">{{$set->best_de}}</textarea>
               </div>
        </div>
        <div class="separator separator-dashed my-10"></div>
       </div>
      ...
      <div class="row">
       ...
       <div class="col-xl-8">
        <div class="my-52">
            <div class="form-group mb-1">
                <label for="exampleTextarea">Best Event:</label>
                <textarea class="form-control editor"   name="best_cz" rows="3">{{$set->best_cz}}</textarea>
               </div>
        </div>
        <div class="separator separator-dashed my-10"></div>
        <div class="my-52">
