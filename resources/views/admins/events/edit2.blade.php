...
<form action="{{route('event.updateevent',$event->id)}}" method="POST" id="kt_project_settings_form" class="form" enctype="multipart/form-data">
    @csrf
      ...
      <div class="row">
       ...
       <div class="col-xl-8">
        ...
        <div class="my-5">
         ...
         <div class="form-group row">
          <label class="col-3">Event place:</label>
          <div class="col-9">
        ...
        <div class="my-52">
            <div class="form-group mb-1">
                ...
                <textarea class="form-control formdataforev"   name="overview" rows="3" >{{$event->overview}}</textarea>
               </div>
        </div>
           <div class="separator separator-dashed my-10"></div>
        <div class="my-52">
         ...
         <div class="form-group mb-1">
            ...
            <textarea class="form-control formdataforev"  name="includes" rows="3" >{{$event->includes}}</textarea>
           </div>
        ...
        <div class="my-52">
         ...
         <div class="form-group mb-1">
            ...
            <textarea class="form-control formdataforev" name="excludes" rows="3" >{{$event->excludes}}</textarea>
           </div>
           </div>
        ...
        <div class="my-52">
         ...
         <div class="form-group mb-1">
            ...
            <textarea class="form-control formdataforev" name="how" rows="3" >{{$event->how}}</textarea>
           </div>
           </div>
        ...
        <div class="row mt-3 mb-3 mb-8">
            ...
            <div class="col-xl-9 fv-row mt-3 mb-3">
                ...
                value="{{$event->price_child}}" required/>
            </div>
        </div>
         <div class="separator separator-dashed my-10"></div>
        <div class="row mt-3 mb-3 mb-8">
            ...
            <div class="col-xl-9 fv-row mt-3 mb-3">
                <input type="text" class="form-control form-control-solid"  name="latitude" value="{{$event->latitude}}" />
            </div>
        </div>
        <div class="separator separator-dashed my-10"></div>
        <div class="row mt-3 mb-3 mb-8">
            ...
            <div class="col-xl-9 fv-row mt-3 mb-3">
                <input type="text" class="form-control form-control-solid"  name="longitude" value="{{$event->longitude}}"/>
            </div>
        </div>
        <div class="separator separator-dashed my-10"></div>
        ...
        <div class="row mt-3 mb-3 mb-8">
            ...
            <div class="col-xl-9 fv-row mt-3 mb-3">
                <textarea class="form-control" name="descriptiuonadditionalprice_en" rows="3">{{ $event->descriptiuonadditionalprice_en }}</textarea>
            </div>
        </div>
        <div class="separator separator-dashed my-10"></div>
        <!--<div class="row mt-3 mb-3 mb-8">-->
        ...
        <!--        value="{{$event->availability}}" required/>-->
        <!--    </div>-->
        <!--</div>-->
        <!--<div class="separator separator-dashed my-10"></div>-->
        <div class="row mt-3 mb-3 mb-8">
                ...
                <div class="col-xl-9 fv-row mt-3 mb-3">
                    <div class="container">
                        ...
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" name="sat" @if (str_contains($event->availability, 'sat'))
                                checked
                        ...
                        <div class="form-check form-check-inline">
                            <input  class="form-check-input" name="sun" @if  (str_contains($event->availability, 'sun'))
                            checked
                        ...
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" name="mon" @if  (str_contains($event->availability, 'mon'))
                            checked
                        ...
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" name="tue" @if  (str_contains($event->availability, 'tue'))
                            checked
                        ...
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" name="wed" @if  (str_contains($event->availability, 'wed'))
                            checked
                        ...
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" name="thu" @if  (str_contains($event->availability, 'thu'))
                            checked
                        ...
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" name="fri" @if  (str_contains($event->availability, 'fri'))
                            checked
            ...
            <div class="col-lg-8">
                ...
                <div class="image-input image-input-outline" data-kt-image-input="true"
                    ...
                    <div class="image-input-wrapper w-125px h-125px bgi-position-center"
                        style="background-size: 75%; background-image: url({{ asset('images/events/'.$event->image) }})">
                    </div>
    ...
    <div class="card-body">
     <!--begin::Form-->
      ...
      <div class="row">
       <div class="col-xl-2"></div>
       <div class="col-xl-8">
        @include('admins.events.germedit')
       </div>
       <div class="col-xl-2"></div>
      </div>
       ...
       <div class="col-xl-8">
        <div class="my-5">
         ...
         <div class="form-group row">
            ...
            <div class="col-9">
             <input class="form-control form-control-solid" type="text" name="title_cz" value="{{$event->title_cz}}" required/>
            </div>
           </div>
        ...
        <div class="my-5">
         ...
         <div class="form-group row">
            ...
            <div class="col-9">
             <textarea class="form-control" name="descriptiuonadditionalprice_cz" rows="3" >{{$event->descriptiuonadditionalprice_cz}}</textarea>
            </div>
           </div>
        ...
        <div class="my-52">
               <div class="form-group mb-1">
                ...
                <textarea class="form-control formdataforev"  name="overview_cz" rows="3" >{{$event->overview_cz}}</textarea>
               </div>
        </div>
        ...
        <div class="my-52">
           ...
           <div class="form-group mb-1">
            <label for="exampleTextarea">Includes:</span></label>
            <textarea class="form-control formdataforev" name="includes_cz" rows="3" >{{$event->includes_cz}}</textarea>
           </div>
        ...
        <div class="my-52">
               <div class="form-group mb-1">
                <label for="exampleTextarea">How can i contact the organizer with any question?:</span></label>
                <textarea class="form-control formdataforev"  name="overview_cz" rows="3" >{{$event->how_cz}}</textarea>
               </div>
        </div>
        ...
        <div class="my-52">
           ...
           <div class="form-group mb-1">
            <label for="exampleTextarea">Excludes:</span></label>
            <textarea class="form-control formdataforev"  name="excludes_cz" rows="3" >{{$event->excludes_cz}}</textarea>
           </div>
           </div>
